...
CREATE TABLE Keywords (id INTEGER PRIMARY KEY , movie_id integer, keyword varchar(50));
CREATE TABLE Locations (id INTEGER PRIMARY KEY , movie_id integer, location varchar(50));
...
CREATE INDEX kid on Keywords (id);
CREATE INDEX kmid on Keywords (movie_id);
CREATE INDEX lid on Locations (id);
CREATE INDEX lmid on Locations (movie_id);
